...
public class GestionActualizacionLibrosAsim {
    //ATRIBUTOS
    ...
    public static void main(String [] argumentos) {
        new GestionActualizacionLibrosAsim().metodoPrincipal();
    }
    ...
    private void actualizacionFichero() {
        ...
        if (fichero.exists()) {
            ...
            while (!actualizacion.esCentinela()) {
                while (libro.getCodigo() < actualizacion.getCodigo()) {
            ...
            //ASiodjsaoifhsiofshdfishdgiohsoi - Fusión asimétrica
