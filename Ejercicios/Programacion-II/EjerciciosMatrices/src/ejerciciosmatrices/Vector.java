...
public class Vector {
    ...
    public static double productoEscalar(Vector a, Vector b) {
        ...
        try {
            if (a.vector.length != b.vector.length) {
                throw new Exception("Rangos inconsistentes");
            }
    ...
    public void ponerElemento(int posicion, double valor)
    {
        try{
            if (posicion < vector.length)
                ...
                throw new Exception("Rangos incosistentes");
        }
        catch (Exception e) {}
    }
    ...
    public void mostrarCombinaciones()
    {
        ...
        combinaciones(v, iter);
    }
    
    private void combinaciones(Vector v, int iter)
    {        
    ...
    public Vector copiar()
    {
        ...
        //for (int i = 0; i < vector.length; i++) v.vector[i] = vector[i];
        return v;
    }
}
