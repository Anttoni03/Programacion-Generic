...
con el caracter '.', visualiza el número de palabras contenidas en la secuencia.
...
public class contarPalabrasSecuencia {
    ...
    public static void main(String [] argumentos) throws Exception {
        new contarPalabrasSecuencia().metodoPrincipal();
    }
    ...
    private void metodoPrincipal() throws Exception {
        ...
        while (caracter!=FINAL_SECUENCIA) {
            //tratamiento palabra contabilizando la palabra detectada a través
            //de la lectura de su primer caracter
            numeroPalabras++;
        ...
        System.out.println("EL NÚMERO DE PALABRAS CONTENIDAS EN LA SECUENCIA ES "+numeroPalabras);
