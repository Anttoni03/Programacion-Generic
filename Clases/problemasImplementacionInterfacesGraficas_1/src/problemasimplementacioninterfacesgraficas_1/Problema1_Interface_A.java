...
a las siguientes componentes:
    ...
    - Componente JButton rojo  al pulsar el botón AZUL el contenedor JPanel
    visualizador se visualizará con el color azul.
    - Componente JButton rojo  al pulsar el botón MAGENTA el contenedor
    JPanel visualizador se visualizará con el color magenta.
    - Componente JButton rojo  al pulsar el botón AMARILLO el contenedor
...
DISEÑO INTERFACE: ver pdf Problema1_Interface_A.pdf
...
public class Problema1_Interface_A {
    //ATRIBUTOS
    private JPanel visualizador;
    ...
    public static void main(String[] args) {
        new Problema1_Interface_A().metodoPrincipal();        
    }
...
////////MANIPULADOR DE EVENTOS gestorEventos
        ActionListener gestorEventos=new ActionListener()  { 
                ...
                public void actionPerformed(ActionEvent evento)  { 
                        ...
                        visualizador.setBackground(colorFondo);
                }
        }; 
...
////////DECLARACIÓN COMPONENTE AreaDibujo visualizador
