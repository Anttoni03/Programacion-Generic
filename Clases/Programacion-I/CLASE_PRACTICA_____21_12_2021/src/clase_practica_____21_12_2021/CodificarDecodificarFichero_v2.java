...
NOTA: UTILIZACIÓN CLASE CodificacionAlfabetica_V2
 */
...
public class CodificarDecodificarFichero_v2 {
    ...
    //declaración atributo entero para representar semilla aleatoria
    //para la codificación y decodificación
    private int semilla=5; //por defecto tendrá el valor 5.
    
    //declaración método main
    public static void main( String args[] ) throws Exception {
        new CodificarDecodificarFichero_v2().programaPrincipal();
    }
    ...
    public void codificacioDecodificacion(int operacion) throws Exception {
        ...
        //codificación
        CodificacionAlfabetica_V2 codificacion;
        ...
        codificacion=new CodificacionAlfabetica_V2(semilla);
        ...
        while (codigo!=FINAL_FICHERO) {   
            ...
            //verificar si caracter es un caracter a codificar
    ...
    public void solitudNombresFicheros(int operacion) throws Exception {
        borrarPantalla();
        switch (operacion) {
