...
DE VECES QUE APARECEN EN EL FICHERO DE TEXTO IMPLICANDO UN RECORRIDO DEL FICHERO
PARA CADA UNA DE ÉSTAS PALABRAS.
 */
package clase_practica_____21_12_2021;

public class problemaClase_14_12_2021___5_v1 {
    //método main
    public static void main(String [] argumentos) throws Exception {
        new problemaClase_14_12_2021___5_v1().metodoPrincipal();
    }
    ...
    private void metodoPrincipal() throws Exception {
        ...
        //nota --> se supone que le usuario es perfecto y siempre en la secuencia
        ...
        //REALIZANDO UN TRATAMIENTO DE RECORRIDO DE LECTURA DEL FICHERO POR
        //CADA ESTAS PALABRAS
        for (int indice=0;indice<palabras.length;indice++) {
            ...
            //BUCLE DE LECTURA DEL FICHERO A NIVEL DE OBJETOS Palabra Y CONTABILIZACIÓN
            //DEL NÚMERO DE APARICIONES EN EL FICHERO DE LA PALABRA ALMACENADA EN LA COMPONENTE
            //indice DEL ARRAY palabras
            while (fichero.hayPalabras()) {
                //lectura objeto Palabra desde el fichero
                palabra=fichero.lectura();
                //verificar si el objeto Palabra leído desde el fichero es igual
                //a la palabra almacenada en la componente indice del array palabras
                if (Palabra.iguales(palabra, palabras[indice])) {
                    //incrementar contador correspondiente (componente indice del
                    //array numeroApariciones
