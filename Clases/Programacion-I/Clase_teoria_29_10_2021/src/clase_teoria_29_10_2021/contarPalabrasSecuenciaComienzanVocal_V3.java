...
NOTA: ADAPTACIÓN PARA CARACTERES MINÚSCULAS Y MAYÚSCULAS
...
public class contarPalabrasSecuenciaComienzanVocal_V3 {
    ...
    public static void main(String [] argumentos) throws Exception {
        new contarPalabrasSecuenciaComienzanVocal_V3().metodoPrincipal();
    }
