...
NOTA: LAS PALABRAS SERÁN GRABADAS EN EL FICHERO CON UN SEPARADOR ESPACIO EN UNA
ÚNICA LINEA.
 */
package clase_teoría___10_12_2021;

public class FicherosPalabras__Problema2_v1 {
    //método main
    public static void main(String [] argumentos) throws Exception {
        new FicherosPalabras__Problema2_v1().metodoPrincipal();
    }
    ...
    private void metodoPrincipal() throws Exception {
        ...
        while (Palabra.hayPalabras()) {
            ...
            //escritura separador espacio en el fichero palabras2.txt
