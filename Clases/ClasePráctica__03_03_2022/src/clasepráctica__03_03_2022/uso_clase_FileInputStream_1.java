...
/*
FUNCIONALIDAD: visualiza los bytes contenidos en un fichero de nombre datos1.dat
OBJETIVOS:
    - uso de la clase FileInputStream.
autor: Juan Montes de Oca
 */

public class uso_clase_FileInputStream_1 {
    //declaración método main
    public static void main(String [] argumentos) throws Exception {
        new uso_clase_FileInputStream_1().metodoPrincipal();
    }    
    ...
    public void metodoPrincipal()  {    
        ...
        try {
            ...
            //datos1.dat
            fichero=new FileInputStream("datos1.dat");
            try {
