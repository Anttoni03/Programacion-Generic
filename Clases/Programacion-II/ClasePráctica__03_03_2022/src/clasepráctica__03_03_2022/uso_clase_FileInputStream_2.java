...
/*
FUNCIONALIDAD: visualiza los caracteres correspondientes a los bytes contenidos 
en un fichero de nombre datos2.dat
OBJETIVOS:
    - uso de la clase FileInputStream.
autor: Juan Montes de Oca
 */

public class uso_clase_FileInputStream_2 {
    //declaración método main
    public static void main(String [] argumentos) {
        new uso_clase_FileInputStream_2().metodoPrincipal();
    }    
    ...
    public void metodoPrincipal() {    
        ...
        try {
            ...
            //datos1.dat
            fichero=new FileInputStream("datos2.dat");
            try {
                //lectura primer byte del fichero
                codigo=fichero.read();
                //bucle de lectura y visualización
                while (codigo!=FINAL_FICHERO) {
                    //visualización caracter correspondiente al byte leido
