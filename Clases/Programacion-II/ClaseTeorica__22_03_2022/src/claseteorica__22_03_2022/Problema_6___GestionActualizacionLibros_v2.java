...
public class Problema_6___GestionActualizacionLibros_v2 {
    //ATRIBUTOS
    ...
    public static void main(String [] argumentos) {
        new Problema_6___GestionActualizacionLibros_v2().metodoPrincipal();
    }
    ...
    private void altaActualizaciones() {
        ...
        if (continuar) {
            ...
            for (boolean fin=false;!fin;) {
                ...
                actualizacion.setActualizacion(TiposActualizacion.MODIFICACION);
