...
public class FicheroObjetosPalabraOutAdd {
    //ATRIBUTOS
    ...
    //MÉTODO CONSTRUCTOR
    public FicheroObjetosPalabraOutAdd(String nombreFichero) { 
       try {
    ...
    public void escritura(Palabra palabra) {
        try {
            ...
            if (fichero2==null) {
                ...
                fichero1.writeObject(palabra);
            }
            else {
                //escritura objeto Palabra dado
                fichero2.writeObject(palabra);
            }
        }
        catch (IOException error) {
            System.out.println("ERROR: "+error.toString());
