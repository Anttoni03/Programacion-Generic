...
import javax.swing.*;
public class graficos7 {
    //declaración método main
    public static void main(String[] args) { 
        new graficos7().metodoPrincipal();
    }
    ...
    class panelDibujo extends JPanel {
        ...
        public void paint(Graphics g) {
            ...
            //DIBUJAR UN RECTÁNGULO CON drawRoundRect
            g.setColor(Color.green);
            g.drawRoundRect(10, 10, 300, 200,20,20);       
        }
    }
}
