...
import javax.swing.*;
public class graficos8 {
    //declaración método main
    public static void main(String[] args) { 
        new graficos8().metodoPrincipal();
    }
    ...
    class panelDibujo extends JPanel {
        ...
        public void paint(Graphics g) {
            ...
            //DIBUJAR UN RECTÁNGULO CON fillRoundRect 
            g.setColor(Color.green);
            g.fillRoundRect(10, 10, 300, 200,20,20);       
        }
    }
}
