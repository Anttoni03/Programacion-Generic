...
public class eventos_MouseListener_v1 {
    //DECLARACIÓN ATRIBUTOS QUE SON COMPARTIDOS POR MÁS DE UN MÉTODO DE LA CLASE
    private panelDibujo panelSuperior,areaColor1,areaColor2,areaColor3,areaColor4;
    
    //declaración método main
    public static void main(String[] args) { 
        new eventos_MouseListener_v1().metodoPrincipal();
    }
...
//////////////////////////////////////////////////////////////////////////////// 
/////////////  DECLARACIÓN CONTENEDOR panelDibujo panelSuperior ////////////////
...
//////////// DECLARACIÓN OBJETOS CONTENEDORES JPanel panelDibujo ///////////////
        //INSTANCIACIÓN CONTENEDOR areaColor1
        areaColor1=new panelDibujo(85,85,Color.RED);
        //INTRODUCCIÓN CONTENEDOR areaColor1 EN EL CONTENEDOR JPanel panelColores
        panelColores.add(areaColor1);
        //ASIGNACIÓN DEL GESTOR DE EVENTOS MouseEvent AL CONTENEDOR areaColor1
        //CON LA INTERFACE MouseListener
        areaColor1.addMouseListener(new gestorEventosRaton());
        
        //INSTANCIACIÓN CONTENEDOR areaColor2
        areaColor2=new panelDibujo(85,85,Color.BLUE);
        //INTRODUCCIÓN CONTENEDOR areaColor2 EN EL CONTENEDOR JPanel panelColores
        panelColores.add(areaColor2);
        //ASIGNACIÓN DEL GESTOR DE EVENTOS MouseEvent AL CONTENEDOR areaColor2
        //CON LA INTERFACE MouseListener
        areaColor2.addMouseListener(new gestorEventosRaton());
        
        //INSTANCIACIÓN CONTENEDOR areaColor3
        areaColor3=new panelDibujo(85,85,Color.GREEN);
        //INTRODUCCIÓN CONTENEDOR areaColor3 EN EL CONTENEDOR JPanel panelColores
        panelColores.add(areaColor3);
        //ASIGNACIÓN DEL GESTOR DE EVENTOS MouseEvent AL CONTENEDOR areaColor3
        //CON LA INTERFACE MouseListener
        areaColor3.addMouseListener(new gestorEventosRaton());       
        
        //INSTANCIACIÓN CONTENEDOR areaColor4
        areaColor4=new panelDibujo(85,85,Color.YELLOW);
        //INTRODUCCIÓN CONTENEDOR areaColor4 EN EL CONTENEDOR JPanel panelColores
        panelColores.add(areaColor4);
        //ASIGNACIÓN DEL GESTOR DE EVENTOS MouseEvent AL CONTENEDOR areaColor4
        //CON LA INTERFACE MouseListener
        areaColor4.addMouseListener(new gestorEventosRaton());
