...
SIN UTILIZACIÓN BUFFER DE IMAGEN
SIMPLIFICADO
...
public class TALLER2_SIN_BUFFER_IMAGEN_SIMPLIFICADO extends JFrame {
////////DECLARACIÓN ATRIBUTOS
    enum tipoComponenteMotivo {STROKE,PAINT,TRAZADO}
    private TALLER2_SIN_BUFFER_IMAGEN_SIMPLIFICADO ventana;
    ...
    private ObjetoGrafico [] objetos=new ObjetoGrafico[MAXIMO];
    private int numeroObjetos=0;
    ...
    public static void main(String[] args) {
        ...
        new TALLER2_SIN_BUFFER_IMAGEN_SIMPLIFICADO();        
    }
    
    
////////CONSTRUCTOR
    
    public TALLER2_SIN_BUFFER_IMAGEN_SIMPLIFICADO() {       
        ...
        setDefaultCloseOperation(TALLER2_SIN_BUFFER_IMAGEN_SIMPLIFICADO.EXIT_ON_CLOSE);
...
////////MÉTODOS
    ...
    private void creacionContenedoresYComponentes() {
        ...
        //INCLUSIÓN DE LA COMPONENTE barraMenu EN EL SEPARADOR separadorNorte 
...
/////////////////// FIN MÉTODO creacionContenedoresYComponentes ////////////////
    ...
    public class AreaVisualizacion extends JPanel {
        ...
        public void paintComponent(Graphics g){
            ...
            pintarFondo();
            for (int indice=0;indice<numeroObjetos;indice++) {
                //EN FUNCIÓN DEL TIPO DE OBJETO A DIBUJAR/VISUALIZAR
                switch (objetos[indice].getTipo()) {
                    case LINEA:      //asignación al objeto Graphics2D g2ImagenBuffer
                                     //del buffer de imagenTextura imagenBuffer del
                                     //color de trazado del objeto actual
                                     g2.setColor(objetos[indice].getColorTrazado());
                                     //asignación al objeto Graphics2D g2ImagenBuffer
                                     //del buffer de imagenTextura imagenBuffer sel
                                     //atributo de stroke del objeto actual
                                     g2.setStroke(objetos[indice].getStroke());
                                     //trazado del objeto en el buffer de imagenTextura imagenBuffer
                                     g2.draw((Line2D)objetos[indice].getObjeto() );
                                     break;
                    case RECTANGULO: //asignación al objeto Graphics2D g2ImagenBuffer
                                     //del buffer de imagenTextura imagenBuffer sel
                                     //atributo de stroke del objeto actual
                                     g2.setStroke(objetos[indice].getStroke());
                                     ...
                                     if (visualizacionSolida) {
                                         ...
                                         g2.setPaint(objetos[indice].getPaint());
                                         //visualización sólida (pintado) del objeto actual
                                         //en el buffer de imagenTextura imagenBuffer
                                         g2.fill((Rectangle2D) objetos[indice].getObjeto());                                        
                                     }
                                     //asignación al objeto Graphics2D g2ImagenBuffer
                                     //del buffer de imagenTextura imagenBuffer del
                                     //color de trazado del objeto actual
                                     g2.setColor(objetos[indice].getColorTrazado());
                                     //trazado del objeto en el buffer de imagenTextura imagenBuffer
                                     g2.draw((Rectangle2D) objetos[indice].getObjeto());
                                     break;
                    case ELIPSE:     //asignación al objeto Graphics2D g2ImagenBuffer
                                     //del buffer de imagenTextura imagenBuffer sel
                                     //atributo de stroke del objeto actual
                                     g2.setStroke(objetos[indice].getStroke());
                                     //si es estado de la visualización es solida
                                     ...
                                     if (visualizacionSolida) {
                                         ...
                                         //visualización sólida (pintado) del objeto actual
                                         //en el buffer de imagenTextura imagenBuffer
                                         g2.fill((Ellipse2D) objetos[indice].getObjeto());                                        
                                     }
                                     //asignación al objeto Graphics2D g2ImagenBuffer
                                     //del buffer de imagenTextura imagenBuffer del
                                     //color de trazado del objeto actual
                                     g2.setColor(objetos[indice].getColorTrazado());
                                     //trazado del objeto en el buffer de imagenTextura imagenBuffer
                                     g2.draw((Ellipse2D) objetos[indice].getObjeto());
                                     break;
                    case POLIGONO:   //asignación al objeto Graphics2D g2ImagenBuffer
                                     //del buffer de imagenTextura imagenBuffer sel
                                     //atributo de stroke del objeto actual
                                     g2.setStroke(objetos[indice].getStroke());
                                     //si es estado de la visualización es solida
                                     ...
                                     if (visualizacionSolida) {
                                         ...
                                         //visualización sólida (pintado) del objeto actual
                                         //en el buffer de imagenTextura imagenBuffer
                                         g2.fillPolygon((Polygon) objetos[indice].getObjeto());                     
                                     }
                                     //asignación al objeto Graphics2D g2ImagenBuffer
                                     //del buffer de imagenTextura imagenBuffer del
                                     //color de trazado del objeto actual
                                     g2.setColor(objetos[indice].getColorTrazado());
                                     //trazado del objeto en el buffer de imagenTextura imagenBuffer
                                     g2.drawPolygon((Polygon) objetos[indice].getObjeto());
                                     break;
                    case TEXTO:      //asignación al objeto Graphics2D g2ImagenBuffer
                                     //del buffer de imagenTextura imagenBuffer sel
                                     //atributo de stroke del objeto actual
                                     g2.setStroke(objetos[indice].getStroke());
                                     //asignación al objeto Graphics2D g2ImagenBuffer
                                     ...
                                     //color de trazado del objeto actual
                                     g2.setColor(objetos[indice].getColorTrazado());
                                     //visualización del objeto en el buffer de imagenTextura imagenBuffer
                                     g2.drawString(objetos[indice].getTexto(),
                                                objetos[indice].getPosicionTexto()[0],
                                                objetos[indice].getPosicionTexto()[1]);
                                     break;
                    case IMAGEN:     //lectura del fichero imagenTextura correspondiente al objeto actual 
                                     ...
                                     try {
                                        imagenFichero = ImageIO.read(objetos[indice].getFicheroImagen());
                                     }catch (IOException error) {
                                         System.out.println("ERROR: "+error.toString());
                                     }
                                     //transferir la imagenTextura desde el buffer imagenFichero al
                                     //buffer imagenBuffer asociado al objeto Graphics2D 
                                     //g2ImagenBuffer escalando acorde a las dimensiones del contenedor JPanel de visualización
                                     g2.drawImage(imagenFichero.getScaledInstance(getWidth(), getHeight(), 0),0,0,this);
                                     break;
                }                    
            }
        }
        ...
        //IMAGEN imagenBuffer EN UN FICHERO DE IMAGEN FORMATO JPG
        //FICHERO IMAGEN FORMATO JPG
        public void grabarImagen(File fichero) {
            try {
                BufferedImage imagenVisualizada=new BufferedImage(getWidth(),getHeight(),BufferedImage.TYPE_INT_RGB);
                Graphics gSalvar=imagenVisualizada.createGraphics();
                this.print(gSalvar);
                gSalvar.dispose();
                ImageIO.write(imagenVisualizada, "jpg",fichero);                   
    ...
    //introducción del nombre y selección intercativa del directorio del fichero a salvar
            ...
            switch (evento.getActionCommand()) {
                case "LÍNEA"      :     //declaración array de componentes String con los literales de los conceptos a introducir
                                        ...
                                        if (valoresLinea!=null) {
                                            ...
                                            objetos[numeroObjetos]=new ObjetoGrafico(ObjetoGrafico.tipoObjetoGrafico.LINEA, valoresLinea);
                                            //asignación al ObjetoGrafico creado de los atributos del contexto
                                            //de renderizado de color de trazado, stroke
                                            objetos[numeroObjetos].setColorTrazado(colorTrazado);
                                            objetos[numeroObjetos].setStroke(atributoStroke);
                                            //incrementar numeroObjetos
                                            numeroObjetos++;
                                        }
                                        break;
                case "RECTÁNGULO"   :   //declaración array de componentes String con los literales de los conceptos a introducir
                                        ...
                                        if (valoresRectangulo!=null) {
                                            ...
                                            objetos[numeroObjetos]=new ObjetoGrafico(ObjetoGrafico.tipoObjetoGrafico.RECTANGULO, valoresRectangulo);
                                            //asignación al ObjetoGrafico creado de los atributos del contexto
                                            //de renderizado de color de trazado, stroke y paint
                                            objetos[numeroObjetos].setColorTrazado(colorTrazado);
                                            objetos[numeroObjetos].setPaint(paintActual);
                                            objetos[numeroObjetos].setStroke(atributoStroke); 
                                            //incrementar numeroObjetos
                                            numeroObjetos++;
                                        }
                ...
                case "ELIPSE"   :       //declaración array de componentes String con los literales de los conceptos a introducir
                                        ...
                                        if (valoresElipse!=null) {
                                            ...
                                            objetos[numeroObjetos]=new ObjetoGrafico(ObjetoGrafico.tipoObjetoGrafico.ELIPSE, valoresElipse);
                                            //asignación al ObjetoGrafico creado de los atributos del contexto
                                            //de renderizado de color de trazado, stroke y paint
                                            objetos[numeroObjetos].setColorTrazado(colorTrazado);
                                            objetos[numeroObjetos].setPaint(paintActual);
                ...
                case "POLÍGONO"        ://declaración array de componentes String con los literales de los conceptos a introducir instanciandolo
                                        ...
                                        if (valoresPoligono!=null) {
                                            ...
                                            objetos[numeroObjetos]=new ObjetoGrafico(ObjetoGrafico.tipoObjetoGrafico.POLIGONO, valoresPoligono);
                                            //asignación al ObjetoGrafico creado de los atributos del contexto
                                            //de renderizado de color de trazado, stroke y paint
                                            objetos[numeroObjetos].setColorTrazado(colorTrazado);
                                            objetos[numeroObjetos].setPaint(paintActual);
                ...
                case "TEXTO"           ://declaración array de componentes String con los literales de los conceptos a introducir
                                        ...
                                        if (valoresTexto!=null) {
                                            ...
                                            objetos[numeroObjetos]=new ObjetoGrafico(ObjetoGrafico.tipoObjetoGrafico.TEXTO,valoresTexto);
                                            //asignación al ObjetoGrafico creado de los atributos del contexto
                                            //de renderizado de color de trazado, stroke y paint
                                            objetos[numeroObjetos].setColorTrazado(colorTrazado);
                                            objetos[numeroObjetos].setPaint(paintActual);
                ...
                case "IMAGEN"          ://selección interactiva del fichero imagen 
                                        ...
                                        if (ficheroImagen!=null) {
                                            ...
                                            objetos[numeroObjetos]=new ObjetoGrafico(ObjetoGrafico.tipoObjetoGrafico.IMAGEN,ficheroImagen);
                                            //incrementar numeroObjetos
                                            numeroObjetos++;                                           
                                        }
                ...
                case "ABRIR"           ://selección interactiva del fichero imagen a abrir
                                        ...
                                        if (ficheroImagenAbrir!=null) {
                                            //generación del nuevo ObjetoGrafico del tipo IMAGEN
                                            objetos[numeroObjetos]=new ObjetoGrafico(ObjetoGrafico.tipoObjetoGrafico.IMAGEN,ficheroImagenAbrir);
                                            //incrementar numeroObjetos
                                            numeroObjetos++;
                                        }
                                        break;
                case "BORRAR"          ://inicializar numeroObjetos
                                        numeroObjetos=0;
                                        break;                                                 
