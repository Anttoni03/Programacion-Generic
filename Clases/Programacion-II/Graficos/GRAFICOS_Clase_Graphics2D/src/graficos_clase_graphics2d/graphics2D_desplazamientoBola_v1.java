/*
FUNCIONALIDAD:
SIMULACIÓN DESPLAZAMIENTO BOLA A TRAVÉS DE LA VENTANA
...
public class graphics2D_desplazamientoBola_v1 {
    ...
    public static void main(String[] args) { 
        new graphics2D_desplazamientoBola_v1().metodoPrincipal();
    }
